...
app.get("/api/v1/dashboard/pingpong-7color/range", async (req, res) => {
  ...
  const result = await query(
    `WITH pingpong AS (
     ...
     FROM (VALUES
       ('white', 'ปกติ', 'น้ำตาล <100 mg/dl และความดัน <=120/80 mmHg', 'ส่งเสริมสุขภาพและตรวจคัดกรองตามรอบ', 1),
       ('green', 'เสี่ยง', 'น้ำตาล 100-125 mg/dl หรือความดัน 121/81-139/89 mmHg', 'ปรับพฤติกรรม ควบคุมอาหาร ออกกำลังกาย และติดตามคัดกรอง', 2),
       ('controlled', 'คุมได้ดี', 'น้ำตาล <=125 mg/dl และความดัน <=139/89 mmHg', 'ติดตามต่อเนื่องตามนัดและคงพฤติกรรมที่ควบคุมโรคได้ดี', 3),
       ('yellow', 'เฝ้าระวัง', 'น้ำตาล 126-154 mg/dl หรือความดัน 140/90-159/99 mmHg', 'ปรับแผนดูแลและติดตามค่าน้ำตาล/ความดัน', 4),
       ('orange', 'อันตราย', 'น้ำตาล 155-182 mg/dl หรือความดัน 160/100-179/109 mmHg', 'พบแพทย์ตามนัดใกล้ขึ้นและประเมินการรักษา', 5),
       ('red', 'วิกฤต', 'น้ำตาล >=183 mg/dl หรือความดัน >=180/110 mmHg', 'พบแพทย์โดยเร็วและประเมินภาวะฉุกเฉิน', 6),
       ('black', 'โรคแทรกซ้อน', 'มีภาวะแทรกซ้อนสำคัญ', 'พบแพทย์/ทีมสหวิชาชีพเร่งด่วนและติดตามใกล้ชิด', 7)
